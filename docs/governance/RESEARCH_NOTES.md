...
| Source | Decision supported | Limitation |
|---|---|---|
| [ESA Hipparcos catalogues](https://www.cosmos.esa.int/web/hipparcos/catalogues) | Identifies the original ESA catalogue and its credit/licensing context for historical comparison. | Its terms must not be transferred to the later CDS I/311 reduction by inference. |
| [CDS/VizieR I/311 ReadMe](https://cdsarc.cds.unistra.fr/viz-bin/ReadMe/I/311?format=html&tex=true) | Source metadata for the Phase 1 local-spike catalogue, including file layouts, identifiers, astrometry, proper motion, solution families, quality fields, and photometry. | Field semantics, exact retained scope, acquisition provenance, and redistribution require their separate evidence and approvals. |
| [VizieR I/311 catalogue record](https://cdsarc.cds.unistra.fr/viz-bin/cat/I/311) | Identifies the selected Phase 1 local-spike catalogue and its associated documentation. | Public archive access does not establish redistribution, republication, or deployment rights. |
| [ESA Hipparcos catalogue description](https://hipparcos-tools.cosmos.esa.int/pstex/sect2_01.pdf) | Original-catalogue epoch/frame/component semantics provide supporting comparison context. | They do not automatically define I/311 fields; reviewed I/311-specific evidence remains necessary before constants are encoded. |
