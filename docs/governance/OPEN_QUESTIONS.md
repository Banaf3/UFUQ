...
|---|---|---|---:|---|
| AST-001 | Select the catalogue/table/version, permitted immutable-source access and redistribution model, exact subset rule, required astrometric/photometric/uncertainty fields, quality/duplicate/missing-data rules, magnitude band, and citation. Hipparcos I/239 is only a candidate. | Supervisor + astronomy/data reviewer | P1 | Catalogue acquisition/runtime JSON |
