...
| AST-003 | The Milestone 2C.1 audit confirms I/311 ICRS input, the literal `Ep=1991.25` label, official ESA I/311-specific `J1991.25` usage, starred-alpha `pmRA`, distinct UTC/TAI/TT/UT1 roles, and fixed UFUQ horizontal conventions. The Julian representation is source-supported; the I/311 time scale is not. Obtain an I/311-applicable exact scale/instant statement or approve/reject a bounded TT interpretation with named evidence, alternatives, consequences, and limitations. Also approve the production algorithm/library and supported date range; proper motion model; parallax; radial velocity/perspective acceleration; annual/diurnal aberration; light deflection; precession/nutation; UT1/TT/leap-second/IERS handling; polar motion; geodetic datum/ellipsoid/height; and a quantified implement-or-omit decision for every effect. Define EOP pinning, extrapolation, failure, and labelled approximation modes. | Astronomy expert | P1 | I/311 source-derived propagation, astronomy core/reference fixtures, and Milestone 2C closure |
