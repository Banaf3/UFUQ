...
| JUPEM-GEODETIC | Department of Survey and Mapping Malaysia (JUPEM), official geodetic services and national-datum circulars; [geodetic services](https://ebiz.jupem.gov.my/Perkhidmatan/PerkhidmatanGeodetik) and [GDM circular](https://www.jupem.gov.my/jupem18a/assets/uploads/files/pekeliling/d95f4-pkpup-2-2021.pdf) | PRIMARY_DATASET_DOCUMENTATION | REQUIRED_NOW | Official web; no observer site record selected or stored | Authoritative route to Malaysian datum/reference-frame, ellipsoid, height/geoid, and control-station evidence. It does not select UFUQ's first preset or convert orthometric height silently. A site-specific record must carry coordinates, datum/frame and epoch where applicable, ellipsoidal height, accuracy, provenance, and acquisition identity. |
