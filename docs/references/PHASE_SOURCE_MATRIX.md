...
| Phase 1: astronomy behaviour and data technical spike | UFUQ-ASTRO-SPEC, UFUQ-DATA, UFUQ-ADR-003, UFUQ-ADR-004, UFUQ-ADR-007, ScientificProfileV1 | SOFA-2023-10-11, IERS-TN36-2010, JSON-SCHEMA-CORE-2020-12, JSON-SCHEMA-VALIDATION-2020-12, ASTROPY-DOCS-PIN, PYERFA-PIN, ASTROPY-IERS-DATA-PIN, UMPSA-FK-PEKAN-SITE; HIP-I311-README, ESA-HIP-1997-V1, and VAN-LEEUWEN-2007-VALIDATION only for the I/311 local spike | JUPEM-GEODETIC as an optional 2D observer-data route; EXSUP-3E, FUND-ASTRO-6E, FAIR-2016; KARNEY-2013 only if ellipsoidal Qibla is separately in scope | Approve the bounded profile route/effects, generic one-preset contract and UMPSA site identity, one time domain, leap/EOP semantics, geometric exclusions, and fail-closed outcomes. Exact observer values/artifact, catalogue/release rights, row eligibility, allowlist, crosswalk, and operational artifact bytes move to 2D/2E; production residuals and tolerances follow implementation. |
