...
| Phase 1: astronomy behaviour and data technical spike | UFUQ-ASTRO-SPEC, UFUQ-DATA, UFUQ-ADR-003, UFUQ-ADR-004, UFUQ-ADR-007, ScientificProfileV1 | SOFA-2023-10-11, IERS-TN36-2010, JSON-SCHEMA-CORE-2020-12, JSON-SCHEMA-VALIDATION-2020-12, ASTROPY-DOCS-PIN, PYERFA-PIN, ASTROPY-IERS-DATA-PIN; HIP-I311-README, ESA-HIP-1997-V1, and VAN-LEEUWEN-2007-VALIDATION only for the I/311 local spike | EXSUP-3E, FUND-ASTRO-6E, FAIR-2016; KARNEY-2013 only if ellipsoidal Qibla is separately in scope | Approve the bounded profile route/effects, one observer/time domain, leap/EOP semantics, geometric exclusions, and fail-closed outcomes. Catalogue/release rights, row eligibility, allowlist, crosswalk, and operational artifact bytes move to 2D/2E; production residuals and tolerances follow implementation. |
| Phase 2: minimal data-driven vertical slice | UFUQ-ARCH data-driven guidance, UFUQ-DATA, approved ScientificProfileV1 | The 2D/2E-approved numerical artifact gates astronomy-core start; pinned production/reference fixtures follow code and gate scientific acceptance; approved cultural evidence gates only each learner-facing record that makes the claim | IBN-QUTAYBA-ANWA, KUNITZSCH-1961, HAFEZ-2010; KING sources only as context | Production/reference and any required stronger-independent evidence gate scientific acceptance after implementation; Najdi/regional evidence gates only claims labelled regional; exact membership/routes, Arabic review, and educational review remain missing. |
