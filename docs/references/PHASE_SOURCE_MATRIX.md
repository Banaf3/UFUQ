...
| Phase 1: astronomy and data technical spike | UFUQ-ASTRO-SPEC, UFUQ-DATA, UFUQ-ADR-003, UFUQ-ADR-004, UFUQ-ADR-007 | SOFA-2023-10-11, IERS-TN36-2010, JSON-SCHEMA-CORE-2020-12, JSON-SCHEMA-VALIDATION-2020-12, ASTROPY-DOCS-PIN, PYERFA-PIN, ASTROPY-IERS-DATA-PIN; HIP-I311-README, ESA-HIP-1997-V1, and VAN-LEEUWEN-2007-VALIDATION for the selected I/311 local spike | EXSUP-3E, FUND-ASTRO-6E, FAIR-2016; KARNEY-2013 only if ellipsoidal Qibla is in spike scope | Pin compatible oracle environment/data; approve I/311 local-processing/licence/field/subset/tracking policy; confirm I/311 `pmRA`/epoch semantics; approve frame/time/refraction/range policies; approve Kaaba coordinate/datum before production Qibla geodesy |
| Phase 2: minimal data-driven vertical slice | UFUQ-ARCH data-driven guidance, UFUQ-DATA, Phase 1 evidence | Approved numerical artifact and reference fixtures from Phase 1; approved cultural evidence for every learner-facing record | IBN-QUTAYBA-ANWA, KUNITZSCH-1961, HAFEZ-2010; KING sources only as context | Najdi/regional primary evidence, exact membership/routes, Arabic review, and educational review remain missing |
...
- An independent oracle result is evidence only when its software, datasets, policies,
  inputs, and comparison method are pinned.
