...
| Phase 1: astronomy and data technical spike | UFUQ-ASTRO-SPEC, UFUQ-DATA, UFUQ-ADR-003, UFUQ-ADR-004, UFUQ-ADR-007 | SOFA-2023-10-11, IERS-TN36-2010, JSON-SCHEMA-CORE-2020-12, JSON-SCHEMA-VALIDATION-2020-12, ASTROPY-DOCS-PIN, PYERFA-PIN, ASTROPY-IERS-DATA-PIN; HIP-I311-README, ESA-HIP-1997-V1, and VAN-LEEUWEN-2007-VALIDATION if the acquired I/311 candidate is evaluated | EXSUP-3E, FUND-ASTRO-6E, FAIR-2016; KARNEY-2013 only if ellipsoidal Qibla is in spike scope | Pin oracle environment/data; approve catalogue source/licence/subset; confirm I/311 `pmRA`/epoch semantics; approve frame/time/refraction/range policies; approve Kaaba coordinate/datum before production Qibla geodesy |
