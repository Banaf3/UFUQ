...
|---|---|---|---|---|
| `SOFA-2023-10-11` | IAU SOFA Board, ANSI C release 2023-10-11; local manual 379 PDF pages plus routine source | Searchable manual/source | `CRITICAL_NOW`: `00READ.ME`, introduction, observed-place, time, Earth-attitude, motion, horizon, geodesy, and refraction routines | Studied exact preambles/source for `Atco13`, `Apco13`, `Atioq`, `Hd2ae`, `Ae2hd`, `Era00`, `C2t06a`, `Pnm06a`, `UtcTai`, `UtcUt1`, `TaiTt`, `Pmsafe`, `Refco`, `Eform`, `Gd2gc`, and `Cal2jd`. Other routine families are intentionally outside the current claim. |
| `IERS-TN36-2010` | Petit and Luzum, eds., IERS Technical Note 36, 2010; 180 local PDF pages | Searchable | `CRITICAL_NOW`: Introduction; Ch. 2 §§2.1-2.2; Ch. 4 §§4.1-4.2; Ch. 5 §§5.1-5.6, 5.9; Ch. 10 §10.1; relevant glossary | Studied the listed units, especially Ch. 5 Eqs. (5.1)-(5.3), (5.5), (5.14)-(5.15) and Ch. 10 Eq. (10.1). High-frequency/station/geophysical models remain unstudied until a measured UFUQ need exists. |
